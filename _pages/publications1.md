...
1. Liu, W., **Mei, X.**, Ma, Y., Huang, J., Chen, Q., & Li, H. (2023). Graph L1-Laplacians Regularized GMM for Hyperspectral Unmixing. IEEE Geoscience and Remote Sensing Letters.
...
1. Chu, M., Ma, Y., **Mei, X.**, Huang, J., & Fan, F. (2023). Learning-based correspondence classifier with self-attention hierarchical network. Applied Intelligence, 1-17.
