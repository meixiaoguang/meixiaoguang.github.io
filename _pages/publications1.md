...
1. Yang Yu, Erting Pan, Xinya Wang, Yuheng Wu, **Xiaoguang Mei***, Jiayi Ma, Unmixing before Fusion: A Generalized Paradigm for Multi-modality-based Hyperspectral Image Synthesis, The IEEE/CVF Conference on Computer Vision and Pattern Recognition (**CVPR**) 2024, Seattle, USA, 2024  [**[website]**](https://hsi-synthesis.github.io/)
...
1. Pan, E., Ma, Y., **Mei, X.***, Fan, F., Huang, J., & Ma, J. (2023). Progressive Hyperspectral Image Destriping with an Adaptive Frequencial Focus. IEEE Transactions on Geoscience and Remote Sensing.
